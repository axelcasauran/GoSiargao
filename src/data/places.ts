...
export type Place = {
  ...
  catLabel: string;
  tint: string;
  /** Cover photo (Unsplash — topical stock, not the literal location). */
  image: string;
  tags: string[];
  price: string;
  priceLabel: string;
...
export type EventItem = {
  ...
  tag: string;
  tint: string;
  /** Cover photo (Unsplash — topical stock, not the literal event). */
  image: string;
  place?: string;
};
export const EVENTS: EventItem[] = [
  { id: 'market', name: 'Sunday Pop-up Market', venue: 'Cloud 9', date: 'SUN', day: '22', time: '4–9 PM', tag: 'Market', tint: '#E84F5C', image: unsplash('photo-1533900298318-6b8da08a523e'), place: 'cloud9' },
  { id: 'fullmoon', name: 'Full Moon Beach Party', venue: 'Pacifico Beach', date: 'WED', day: '25', time: '9 PM late', tag: 'Party', tint: '#F2762E', image: unsplash('photo-1530541930197-ff16ac917b0e'), place: 'pacifico' },
  { id: 'reggae', name: 'Live Reggae Night', venue: 'Bravo Beach', date: 'FRI', day: '27', time: '8 PM', tag: 'Music', tint: '#2F7A4F', image: unsplash('photo-1470229722913-7c0e2dbbafd3'), place: 'bravo' },
  { id: 'surfcomp', name: 'Cloud 9 Surf Cup', venue: 'Cloud 9 reef', date: 'SAT', day: '28', time: 'All day', tag: 'Surf', tint: '#0E7C86', image: unsplash('photo-1502680390469-be75c86b636f'), place: 'cloud9' },
];
...
export type MapPin = { id: string; x: string; y: string };
